...
class PostListWorkExperienceUser extends StatefulWidget {
  PostListWorkExperienceUser({Key? key}) : super(key: key);

  @override
  State<PostListWorkExperienceUser> createState() =>
      _PostListWorkExperienceUserState();
}

class _PostListWorkExperienceUserState
    extends State<PostListWorkExperienceUser> {
  GlobalKey<FormState> formKey = GlobalKey<FormState>();
  bool isload = false;

  void postworkexperience() async {
    Apirespose response = await postworkexp(
        Nama_pekerjaan.text,
